      ...
      <div class="row py-5 p-4 bg-white rounded shadow-sm">
        ...
        <div class="col-lg-6">
          ...
          <div class="p-4">
            ...
            </ul><a href="{{ route('checkout.index') }}" class="btn btn-dark rounded-pill py-2 btn-block">procedons a l'achat</a>
          </div>
        </div>
      </div>
...
<div class="col md 12">
    <h2 class=" text_align_center mt-5"> votre panier est vide <i class="fa fa-arrow"></i></h2>
</div>
@endif
